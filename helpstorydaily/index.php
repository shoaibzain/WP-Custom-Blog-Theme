            ...
            <div class="row align-items-center bg-dark">
                <div class="col-12">
                    <div class="d-flex justify-content-between">
                        <div class="bg-primary text-dark text-center font-weight-medium py-2" style="width: 170px;">Trending Now</div>
        ...
        <div class="container">
            ...
            <?php
                $featured_args = array(
                    ...
                    'posts_per_page' => -1, // Change -1 to the number of posts you want to display per page
                    'cat' => 55
                );
            $featured_query = new WP_Query( $featured_args );
            if ( $featured_query->have_posts() ) :  ?>
            <div class="owl-carousel news-carousel carousel-item-4 position-relative">
                <?php foreach ( $featured_query->posts as $post ) : 
                    setup_postdata( $post );
                    $thumbnail_url = get_the_post_thumbnail_url(); 
                    $featured_categories = get_the_category();
                    $post_title = get_the_title(); ?>
                <div class="position-relative overflow-hidden" style="height: 300px;">
                    <img class="img-fluid h-100" src="<?php echo $thumbnail_url; ?>" alt="<?php the_title(); ?>" style="object-fit: cover;">
                    <div class="overlay">
                        <div class="mb-2">
                            <a class="text-white" href="<?php echo get_the_permalink(); ?>"><small><?php echo get_the_date(); ?></small></a>
                        </div>
                        <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href="<?php echo get_the_permalink(); ?>">
                            <?php 
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="row">
                        ...
                        <?php
                                $latest_args = array(
                                    'posts_per_page' => 4, // Change -1 to the number of posts you want to display per page
                                    'offset'         => 7,
                            ...
                            <img class="img-fluid h-100" src="<?php echo $thumbnail_url; ?>" alt="<?php the_title(); ?>" style="object-fit: cover;">
                                <div class="bg-white border border-top-0 p-4">
                                    ...
                                    <?php
                                        ...
                                        if ( ! empty( $category ) ) {
                                            echo '<a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2" href="' . esc_url( get_category_link( $category[0]->term_id ) ) . '">' . esc_html( $category[0]->name ) . '</a>';
                                        }
                                    ?>
                                        <a class="text-body" href="<?php echo get_the_permalink(); ?>"><small><?php echo get_the_date(); ?></small></a>
                                    </div>
                                    <a class="h4 d-block mb-3 text-secondary text-uppercase font-weight-bold" href="<?php echo get_the_permalink(); ?>"><?php echo $post_title; ?></a>
                                    <p class="m-0"><?php
                                                        if ( strlen( $post_content ) > 120 ) {
